...
import TaskIcon from "../../img/taskcircle.png";
import TaskIconNight from "../../img/taskcirclenight.png";
import { Link } from "react-router-dom";

function Taskblock({ isDark, Priority, Date, Title, Tags, URI }) {
      ...
      <Link to={URI}>
        <div className="TaskBlock">
          <div className="TaskHead FeedBottom">
            <img src={isDark ? TaskIconNight : TaskIcon} alt="Task Icon" />
            <div 
              className="Priority" 
